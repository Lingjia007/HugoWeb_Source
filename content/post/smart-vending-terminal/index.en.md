...
date: 2026-07-02
description: "Based on ArtInChip + LVGL v8 + RT-Thread smart vending terminal, an in-depth analysis of how the application tree (layout_node) manages the LVGL render tree, covering Composite pattern dual-tree mapping, Wrap bridging mechanism, strategy-driven Flex/Grid layout, widget factory dynamic creation, event-driven hot updates, and the replacement flow from static skeleton to dynamic components"
categories:
  - "Embedded"
tags:
  - "LVGL"
